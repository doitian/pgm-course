...
function [P MESSAGES DELTAS] = ClusterGraphCalibrate2(P,useSmartMP)
...
while (1),
    ...
    hist = DELTAS(i, j).hist;
    hist(length(hist) + 1) = MessageDelta(prevMessage, currentMessage);
    DELTAS(i, j).hist = hist;
