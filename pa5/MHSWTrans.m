...
stationary_distribution_ratio = LogProbOfJointAssignment(F, A_prop) - LogProbOfJointAssignment(F, A);
p_acceptance = exp(log_QY_ratio + stationary_distribution_ratio + LogR(old_value) - LogR(new_value));
